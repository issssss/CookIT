...
namespace CookIT.MemoryBasedDAL.Tests
{
    ...
    public class RecipeRepositoryTests
    {
        ...
        public void DoesRecipeWithNameAlreadyExistTest()
        {
            ...
            Recipe newRecipe = RecipeFactory.CreateRecipe(1, "Medenjaci", "slatko", indIngred, "Fino", "");
            recRep.addRecipe(newRecipe);
            Recipe newRecipe2 = RecipeFactory.CreateRecipe(5, "Medenjaci", "slatko", indIngred, "Fino", "");
        ...
        public void CreatingThreeRecipesTest()
        {
            ...
            Recipe newRecipe2 = RecipeFactory.CreateRecipe(2, "Cokoladna torta", "slatko", indIngred, "Slag na vrhu", "");
